...
import es.uma.atenea.cepdm.event.electricity.ElectricityReducedAvg;
...
public class ElectricityReducedAvgSubscriber implements StatementSubscriber {
	 ...
	 * Default constructor
	 * */
	public ElectricityReducedAvgSubscriber() {
		this.windowSize = 10;
	}
	 ...
	 * */
	public ElectricityReducedAvgSubscriber(int windowsSize) {
	...
	public void update(Electricity originalEvent, double avgNswPrice, double avgNswDemand, double avgVicPrice, double avgVicDemand) {
		ElectricityReducedAvg event = new ElectricityReducedAvg(originalEvent, avgNswPrice, avgNswDemand, avgVicPrice, avgVicDemand);
