...
public class ElectricityEnrichedMinMaxSubscriber implements StatementSubscriber {
	 ...
	 * Default constructor
	 * */
	public ElectricityEnrichedMinMaxSubscriber() {
		this.windowSize = 10;
	}
	 ...
	 * */
	public ElectricityEnrichedMinMaxSubscriber(int windowsSize) {
	...
	public void update(Electricity originalEvent, 
		...
		ElectricityEnrichedMinMax event = new ElectricityEnrichedMinMax(originalEvent, minNswPrice, maxNswPrice,
